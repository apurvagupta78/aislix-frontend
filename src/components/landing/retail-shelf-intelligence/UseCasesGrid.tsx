...
export function UseCasesGrid() {
  return (
    <section id="use-cases" className="scroll-mt-16 bg-landing-surface py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <SectionHeading eyebrow="Use cases" title="Built for Every Retail Team" />
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {CASES.map(({ Icon, title, body }) => (
            <div key={title} className="rounded-xl border border-landing-border bg-card p-5 shadow-soft">
