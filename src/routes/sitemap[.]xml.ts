...
const BASE_URL = "https://aislix.com";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/retail-intelligence", changefreq: "monthly", priority: "0.8" },
          { path: "/retail-shelf-intelligence", changefreq: "monthly", priority: "0.9" },
          ...
          { path: "/refunds", changefreq: "monthly", priority: "0.6" },
        ];
