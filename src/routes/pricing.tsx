...
function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-muted/20">
      <SiteHeader />
      <main>
        <section className="mx-auto max-w-[76rem] px-5 pb-10 pt-20 text-center sm:px-8 sm:pt-24 lg:pt-28">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-brand">Pricing</p>
          <h1 className="mx-auto mt-5 max-w-3xl text-3xl font-semibold tracking-tight text-foreground sm:text-4xl lg:text-5xl">
          ...
          <div className="mx-auto mt-8 flex max-w-md flex-wrap items-center justify-center gap-2 sm:gap-3">
        ...
        <section className="mx-auto max-w-[76rem] px-5 pb-8 sm:px-8">
        ...
        <section className="mx-auto max-w-3xl px-5 py-4 text-center sm:px-8">
        ...
        <section ref={compareRef} className="mx-auto max-w-[76rem] scroll-mt-24 px-5 py-12 sm:px-8">
        ...
        <section className="border-t border-border/60 bg-white">
          <div className="mx-auto flex max-w-[76rem] flex-col items-start gap-5 px-5 py-14 sm:flex-row sm:items-center sm:justify-between sm:px-8">
            <div>
