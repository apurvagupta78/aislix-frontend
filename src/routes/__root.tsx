...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aislix — AI Retail Shelf Intelligence" },
      {
        name: "description",
        content:
          "Aislix audits retail shelves automatically with computer vision for supermarkets, dark stores, warehouses, FMCG brands, distributors and local stores.",
      },
    ...
    scripts: [
      {
        ...
        children: `(function(){
var href="https://fonts.googleapis.com/css2?family=Sora:wght@500;600;700&family=Manrope:wght@400;500;600;700&display=swap";
      ...
      <body>
        ...
        <noscript>
          ...
          <img
            ...
            style={{ display: "none" }}
            alt=""
            src="https://px.ads.linkedin.com/collect/?pid=10805217&fmt=gif"
          />
        </noscript>
      </body>
    </html>
