...
export const DEMO_WORKSPACE_DASHBOARD: WorkspaceDashboardData = {
  ...
  attention_cards: [
    {
      key: "availability",
      area_label: "Availability",
      score: 91,
      score_display: "91%",
      explanation: "3 open issues need attention in this area.",
      issue_count: 3,
      variance: "4 pts below target",
      scan_id: "DEMO-8241",
    ...
    {
      key: "shelf_execution",
      area_label: "Shelf Execution",
      score: 84,
      score_display: "84%",
      explanation: "Planogram placement gaps detected on recent visits.",
      issue_count: 4,
      variance: "11 pts below target",
      scan_id: "DEMO-8229",
      action_label: "View audits →",
    ...
    {
      key: "assortment",
      area_label: "Assortment",
      score: 88,
      score_display: "88%",
      explanation: "Assortment is stable across audited stores.",
      issue_count: 2,
      variance: "7 pts below target",
      scan_id: "DEMO-8241",
      action_label: "View audits →",
    ...
    },
    {
      ...
      area_label: "Pricing & Promotions",
      score: 92,
      score_display: "92%",
      explanation: "Promotional compliance is generally strong.",
      issue_count: 2,
      variance: "3 pts below target",
      scan_id: "DEMO-8229",
      action_label: "View audits →",
    ...
    {
      key: "store_issues",
      area_label: "Store Issues",
      score: 86,
      score_display: "86%",
      explanation: "12 open issues across the selected stores.",
      issue_count: 12,
      variance: null,
      scan_id: "DEMO-8241",
      action_label: "View audits →",
